...
template <> constexpr inline auto Dialog::qt_create_metaobjectdata<qt_meta_tag_ZN6DialogE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "Dialog",
        "on_chooseFile_clicked",
        "",
        "on_saveFile_clicked",
        "on_analyze_clicked",
        "on_zoomIn_clicked",
        "on_zoomOut_clicked",
        "on_resetView_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_chooseFile_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_saveFile_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_analyze_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_zoomIn_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_zoomOut_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_resetView_clicked'
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->on_resetView_clicked(); break;
        default: ;
        }
    }
    (void)_a;
