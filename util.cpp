  ...
  while (tree != NULL) {
    ...
    if (tree->nodekind == StmtK) {
      ...
      case PlusEqK:
        ...
        break;
      case MinusEqK:
        fprintf(listing, "MinusEqual: %s\n", tree->attr.name);
        break;
      case IncK:
        fprintf(listing, "Inc: %s\n", tree->attr.name);
        break;
      case DecK:
        fprintf(listing, "Dec: %s\n", tree->attr.name);
        break;
      case WhileK:
...
const char *getTreeNodeInfo(TreeNode *tree) {
  ...
  if (tree->nodekind == StmtK) {
    ...
    case PlusEqK:
      ...
      break;
    case MinusEqK:
      ss << "MinusEqual: " << tree->attr.name;
      break;
    case IncK:
      ss << "Inc: " << tree->attr.name;
      break;
    case DecK:
      ss << "Dec: " << tree->attr.name;
      break;
    case WhileK:
      ss << "While";
      break;
  ...
  char *info = (char *)malloc(ss.str().length() + 1);
