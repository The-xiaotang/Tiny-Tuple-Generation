...
typedef enum 
   ...
   {ENDFILE,ERROR,
    ...
    LBACKET,RBACKET,LBRACE,RBRACE,
    /* 扩展的运算符 */
    PLUS_EQ,MINUS_EQ,INC,DEC,REMAIN,POWER,
    /* 正则表达式操作符*/
...
typedef enum {IfK,RepeatK,AssignK,ReadK,WriteK,ForK,WhileK,PlusEqK,MinusEqK,IncK,DecK,RegK} StmtKind;
